...
t_type* t_type_of<xemmaix::suisha::t_wait>::f_derive(t_object* a_this)
{
	return nullptr;
}
...
t_scoped t_type_of<xemmaix::suisha::t_wait>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
...
t_type* t_type_of<xemmaix::suisha::t_timer>::f_derive(t_object* a_this)
{
	return nullptr;
}
...
t_scoped t_type_of<xemmaix::suisha::t_timer>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	t_throwable::f_throw(L"uninstantiatable.");
}
...
t_type* t_type_of<suisha::t_loop>::f_derive(t_object* a_this)
{
	return nullptr;
}

t_scoped t_type_of<suisha::t_loop>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	t_throwable::f_throw(L"uninstantiatable.");
}
